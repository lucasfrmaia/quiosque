...
export type NotaFiscalCreatePayload = Omit<NotaFiscalVenda, 'id' | 'produtos'> & {
...
export type ProdutoCompraCreate = Omit<ProdutoCompra, 'id' | 'produto' | 'notaFiscal'>;
...
export type TipoUnidade = 'UNIDADE' | 'KG' | 'MG' | undefined;
