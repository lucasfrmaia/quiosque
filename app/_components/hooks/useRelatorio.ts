...
export const useVendasPorPeriodo = (periodo: 'daily' | 'weekly' | 'monthly' | 'annual') => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`${api_url}/api/relatorio/vendas?type=por-periodo&periodo=${periodo}`);
      if (!response.ok) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(
        `${api_url}/api/relatorio/vendas?type=comparativo-periodos&startDate1=${startDate1}&endDate1=${endDate1}&startDate2=${startDate2}&endDate2=${endDate2}`,
      );
      if (!response.ok) {
...
export const useProdutosMaisVendidos = (
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(
        `${api_url}/api/relatorio/vendas?type=produtos-mais-vendidos&limit=${limit}&by=${by}`,
      );
      if (!response.ok) {
...
export const useVendasPorCategoria = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`${api_url}/api/relatorio/vendas?type=vendas-por-categoria`);
      if (!response.ok) {
...
export const useMargemLucroPorProduto = (limit: number = 10) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`${api_url}/api/relatorio/vendas?type=margem-lucro&limit=${limit}`);
      if (!response.ok) {
...
export const usePosicaoEstoqueAtual = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`${api_url}/api/relatorio/estoque?type=posicao-atual`);
      if (!response.ok) {
...
export const useCurvaABCEstoque = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`${api_url}/api/relatorio/estoque?type=curva-abc`);
      if (!response.ok) {
...
export const useGiroEstoque = (periodo: 'monthly' | 'annual' = 'monthly') => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`${api_url}/api/relatorio/estoque?type=giro&periodo=${periodo}`);
      if (!response.ok) {
...
export const useProdutosBaixoEstoque = (minLevel: number = 10) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(
        `${api_url}/api/relatorio/estoque?type=baixo-estoque&minLevel=${minLevel}`,
      );
      if (!response.ok) {
...
export const useProdutosSemGiro = (days: number = 90) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`${api_url}/api/relatorio/estoque?type=sem-giro&days=${days}`);
      if (!response.ok) {
...
export const useProdutosProximaValidade = (days: number = 30) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`${api_url}/api/relatorio/estoque?type=proxima-validade&days=${days}`);
      if (!response.ok) {
...
export const useHistoricoComprasPorProduto = (produtoId: number) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(
        `${api_url}/api/relatorio/compras?type=historico-produto&produtoId=${produtoId}`,
      );
      if (!response.ok) {
...
export const useComprasPorFornecedor = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`${api_url}/api/relatorio/compras?type=por-fornecedor`);
      if (!response.ok) {
...
export const useCustosAquisiçãoPorProduto = (produtoId: number) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(
        `${api_url}/api/relatorio/compras?type=custos-aquisicao&produtoId=${produtoId}`,
      );
      if (!response.ok) {
